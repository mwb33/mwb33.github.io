...
We have computed the number of sequences that exist for different orders of $n$. *Thanks to my CS361 Fall 2022-2023 class for helping with this list. Updated December 2025: CS 361 Fall 2025-2026 added 21-33. Special thanks to Andrew Chen and Owen Hayes for wasting enough processor time to get 33. Owen Hayes got 35.*
...
| $\text{NS1D0(19)}$ | 10,872 |
| $\text{NS1D0(21)}$ | 71,292 |
| $\text{NS1D0(23)}$ | 542,354 |
| $\text{NS1D0(25)}$ | 4,581,580 |
| $\text{NS1D0(27)}$ | 41,687,118 |
| $\text{NS1D0(29)}$ | 413,924,544 |
| $\text{NS1D0(31)}$ | 4,403,271,356 |
| $\text{NS1D0(33)}$ | 50,076,997,700 |
| $\text{NS1D0(35)}$ | 606,468,679,920 |
